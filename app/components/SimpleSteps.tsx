...
const SimpleSteps = () => {
  return (
    <div className="
      flex satoshi max-w-[920px] m-auto flex-col items-center justify-center
    ...
    ">
      ...
      <div className='flex flex-row relative w-full justify-between'>
        <div className='flex flex-col gap-5'>
          ...
          <div className='p-[24px] bg-white rounded-[30px]'>
        ...
        />
        <div className='flex flex-col mt-[190px] gap-5'>
          <div className='flex flex-row items-center justify-between bg-white p-5 rounded-[30px]'>
            <p className='text-[#181818] text-[24] font-normal uppercase'>Step one</p>
          ...
          <div className='p-[24px] bg-white rounded-[30px]'>
            ...
            <p className='text-[#717171] text-[16px] font-normal'>Your order arrives at our shared overseas <br />warehouse, where it is checked in and <br />prepared for shipping.</p>
          </div>
        </div>
      </div>

      <img className='ml-[570px]' src="./images/vec.png" />
      ...
      <div className='flex flex-row relative w-full justify-between'>
        ...
        <div className='flex flex-col gap-5'>
          ...
          <div className='p-[24px] bg-white rounded-[30px]'>
            ...
            <p className='text-[#717171] text-[16px] font-normal'>Select your shipping option, view the cost,<br /> and complete payment.</p>
          </div>
        </div>
      </div> 
      ...
      {/* <div className='flex flex-row relative w-full justify-between'>
        ...
        <div className="absolute top-50 right-">
          <img
            src="./images/ve.png"
            alt=""
